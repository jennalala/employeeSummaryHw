...
// employes: (Manager | Intern | Engineer)[]
const render = (employees) => {
  const html = [];
  
  // [{role: "manager", "name: "a"},{role: "manager", "name: "b"}, {role: "Intern", name: "c"}]
  // [{role: "manager", "name: "a"}, {role: "manager", "name: "b"}]
...
const renderManager = (manager) => {
  ...
  // template:string === <html>{{ name }}</html>
